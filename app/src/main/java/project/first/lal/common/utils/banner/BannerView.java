package project.first.lal.common.utils.banner;
...
import project.first.lal.common.utils.PxdipUtils;
...
public class BannerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (currentPosition == i) {
                ...
                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(pageItemWidth + PxdipUtils.dip2px(context, 3), pageItemWidth + PxdipUtils.dip2px(context, 3));
    ...
    protected void onFinishInflate() {
        ...
        pageItemWidth = PxdipUtils.dip2px(context, 5);
